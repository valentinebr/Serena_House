...
if ( ! class_exists( 'avia_sc_productslider' ) )
{
	class avia_sc_productslider extends aviaShortcodeTemplate
	{
		...
		function popup_elements()
		{
			$this->elements = array(
				...
				array(
					...
					array(	
							'type'			=> 'template',
							'template_id'	=> $this->popup_key( 'styling_columns' )
						),
		...
		protected function register_dynamic_templates()
		{
			...
			AviaPopupTemplates()->register_dynamic_template( $this->popup_key( 'styling_columns' ), $c );
...
if ( ! class_exists( 'avia_product_slider' ) )
{
	class avia_product_slider
	{
		...
		public function query_entries( $params = array() )
		{
			...
			if( ! $page || $params['type'] == 'slider' || $params['paginate'] == 'no' ) 
			{
				$page = 1;
			}
