...
if ( ! class_exists( 'avia_sc_contact' ) )
{
	class avia_sc_contact extends aviaShortcodeTemplate
	{
		...
		protected function register_modal_group_templates()
		{
			...
			$desc1 = __( 'When selecting &quot;Valid E-Mail address with special characters&quot; keep in mind, that not all E-Mail systems support this feature properly.', 'avia_framework' );
